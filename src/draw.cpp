...
void drawLine(const size_t x_0, const size_t y_0, const size_t x_1, const size_t y_1, const Color color, const RenderRule rule, void (*addToQueueService)(const Task&)) {
...
void drawSquare(size_t x, size_t y, const size_t w, const size_t h, const Color color, const RenderRule rule, void (*addToQueueService)(const Task&)) {
...
void drawBox(size_t x, size_t y, const size_t w, const size_t h, const Color color, const RenderRule rule, void (*addToQueueService)(const Task&)) {
...
void drawCircle(const size_t x_0, const size_t y_0, const int r, const Color color, const RenderRule rule, void (*addToQueueService)(const Task&)) {
